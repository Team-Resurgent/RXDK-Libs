...
/*
 * Internal debug header for Xbox OS and library components: ASSERT and related
 * debug-build macros.
 */
...
/* RXDK: libd3d8 links xboxkrnl.lib, which already declares DbgPrint
   (shared/include/xboxkrnl/api/dbg.h). Skip xdbg's conflicting redeclaration. */
#ifndef RXDK_D3D8_LINK
ULONG
_cdecl
DbgPrint(
    PCH Format,
