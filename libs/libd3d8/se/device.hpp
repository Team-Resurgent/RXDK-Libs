...
/*
 * Direct3D device object: holds all per-device associated state.
 */
...
// RXDK: globals.cpp defines these inside its extern "C" block; match the linkage
// here (clang rejects the C++-vs-C mismatch that MSVC silently accepted).

extern "C" PPUSH g_StartPut;

extern "C" DWORD g_NullHardwareGetPut[2];
