...
/*
 * NV2A hardware abstraction layer: the CMiniport Hal* routines that initialise
 * and control the memory, framebuffer, DAC, video, graphics and FIFO engine
 * blocks and manage per-channel graphics context load/unload.
 */
