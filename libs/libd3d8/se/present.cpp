...
CONST DWORD g_AntiAliasedRenderStatesCount = sizeof(g_AntiAliasedRenderStates) / 8;
...
CONST DWORD g_AntiAliasedTextureStatesCount = sizeof(g_AntiAliasedTextureStates) / 8;
