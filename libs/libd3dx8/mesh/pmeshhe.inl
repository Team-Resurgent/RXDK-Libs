...
inline DWORD READ_DWORD(PBYTE &pbCur)   /* RXDK: explicit return type (was implicit int) */
{
...
inline WORD READ_WORD(PBYTE &pbCur)   /* RXDK: explicit return type (was implicit int) */
{
