...
/*
 * CD3duAlloc base class and the D3DX memory-allocation conventions. Classes that
 * inherit CD3duAlloc route new/delete through the D3DX allocator, which adds
 * leak tracking and allocation statistics in debug builds and degenerates to
 * plain C++ new/delete otherwise. The rules below spell out when to use it.
 */
