...
/*
 * Declarations for the in-memory IStream (HGLOBAL-backed memory stream), derived
 * from the ole32 memory-stream code -- the MemStm handle APIs and the CMemStm
 * object used by the composer for in-memory persistence.
 */
