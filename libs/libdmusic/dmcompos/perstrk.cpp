...
/*
 * Implementation of CPersonalityTrack, the DirectMusic track that carries
 * time-stamped chord map (personality) references within a segment, so the
 * chord map can change over the course of playback. Handles play, load and
 * save (RIFF) of those references.
 *
