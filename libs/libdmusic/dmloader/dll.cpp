...
/*
 * DLL entry points and the class factories (CLoaderFactory, CContainerFactory)
 * for the DirectMusic loader component.
 *
 * Exceptions are used narrowly here, only around constructing objects that call
 * InitializeCriticalSection, without full stack-unwind semantics: automatic
