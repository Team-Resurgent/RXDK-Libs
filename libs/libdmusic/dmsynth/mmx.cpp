...
/*
 * MMX-accelerated mix engine for the synthesizer. Hand-written MMX assembly
 * that resamples and accumulates voices; the register-allocation notes below
 * document the tight inner loops. Also carries the runtime MMX-detection code.
 */
