...
/* RXDK: the standard <medparam.h> is a MIDL stub that pulls the whole rpc/rpcndr/
   ...
   from our objbase/oleauto shims instead and drop the MIDL import chain. */
#include <objbase.h>
#include <oleauto.h>

/* RXDK: minimal MIDL/rpcndr compat the stripped medparam stub still names. */
#ifndef __RPC_FAR
#define __RPC_FAR
#endif
#ifndef __RPC_USER
...
#endif
#ifndef _RXDK_RPC_IFTYPES_
#define _RXDK_RPC_IFTYPES_
...
/* header files for imported files (RXDK: satisfied by objbase/oleauto above). */
