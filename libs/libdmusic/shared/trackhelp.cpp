...
/*
 * trackhelp.cpp -- CBasicTrack implementation. Provides the shared base-class
 * behavior (reference counting, locking and the default no-op track methods)
 * that concrete DirectMusic track types build on.
 */
