...
/* RXDK: variadic no-ops -- these retail macros are called with multiple args
   (e.g. DPF_LEAVE -> DPF_ENTERLEAVE("Leave, returning %#x", x)); MSVC tolerated
   the arity mismatch (C4002), clang errors on a fixed-arity macro. */
#define DPF_ABSOLUTE(...)
#define DPF_ERROR(...)
#define DPF_RESOURCE(...)
#define DPF_WARNING(...)
