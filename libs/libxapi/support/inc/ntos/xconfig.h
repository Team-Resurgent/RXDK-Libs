...
/*
 * Layout of the Xbox FAT32 config sector.
 */
...
__inline
#endif
VOID XboxTimeZoneNameToWstr(const CHAR* tzname, WCHAR* wstr)
{
...
__inline
#endif
VOID WstrToXboxTimeZoneName(const WCHAR* wstr, CHAR* tzname)
{
    ULONG count = XC_TZNAMELEN;
    while (count--)
        *tzname++ = (CHAR) *wstr++;
