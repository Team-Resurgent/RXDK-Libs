...
/*
 * Defines the well-known COM GUIDs for interfaces that are not generated by the
 * MIDL compiler (such as GUID_NULL). INITGUID is defined so the GUID values are
 * emitted into this translation unit for the UUID library.
 */
