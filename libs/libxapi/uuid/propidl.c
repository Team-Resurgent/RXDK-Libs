...
/*
 * MIDL-generated IID and CLSID definitions for the property-storage interfaces
 * (propidl.idl - IPropertyStorage, IPropertySetStorage and related), linked
 * into the UUID library.
 */
