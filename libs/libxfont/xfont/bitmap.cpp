...
//****************************************************************************
//
// Full bitmap font support, including compressed and TrueType glyph bitmaps
// and disk-file font loading. Only the Xbox path is built: the PC branch
// (xfont-pc.h) sits behind #ifdef _XBOX and is never compiled here.
//
