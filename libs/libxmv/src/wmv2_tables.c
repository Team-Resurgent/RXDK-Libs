//------------------------------------------------------------------------------
// wmv2_tables.c -- WMV2 P-frame VLC tables, copied VERBATIM from FFmpeg
// (libavcodec/msmpeg4data.c, LGPL). Used by wmv2_vlc.c to build decoders for
// the motion-vector VLC (ff_msmp4_mv_table0/1) and the P macroblock-type/CBP
// VLC (ff_wmv2_inter_table = {table_mb_non_intra2,3,4, ff_table_mb_non_intra}).
// Symbol for the MV tables = (mx<<8)|my; for the inter tables = array index.
//------------------------------------------------------------------------------
#include "wmv2_tables.h"

// Helpers from FFmpeg msmpeg4data.c used by the MV-table literals below.
...
const uint32_t table_mb_non_intra2[128][2] = {
...
const uint32_t table_mb_non_intra3[128][2] = {
...
const uint32_t table_mb_non_intra4[128][2] = {
...
const uint32_t (*const ff_wmv2_inter_table[4])[2] = {
    table_mb_non_intra2,
    table_mb_non_intra3,
    table_mb_non_intra4,
