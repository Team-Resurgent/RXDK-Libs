...
private:
    ...
    static void __stdcall TimerDpc(PKDPC pkdpc, void * pvContext, void * pvParam1, void * pvParam2);  // __stdcall: kernel-invoked DPC (base.cpp)
    void            TimerPush();
...
{
    friend class CXnNic;   /* RXDK: clang rejects befriending protected base members by name */
...
private:
    ...
    static void __stdcall EnetDpc(PKDPC, void *, void *, void *);  // __stdcall: kernel-invoked DPC (enet.cpp)
    void            EnetProcessDpc();
...
class NOVTABLE CXnIp : public CXnEnet
{
    ...
    friend class CXnEnet;   /* RXDK: clang rejects befriending protected base members by name */
    ...
    struct CSecReg
    {
        ...
        INLINE      CSecReg() {}
        INLINE BOOL IsXmitReady() { return(_bState >= SR_STATE_INITWAIT); }
        INLINE BOOL IsRecvReady() { return(_bState >= SR_STATE_RESPSENT); }
        char *      CSecReg::Str();
...
class NOVTABLE CXnSock : public CXnIp
{
    ...
    friend class CXnIp;   /* RXDK: clang rejects befriending protected base members by name */
...
INLINE void CTcpSocket::TcpInit(CXnBase * pXnBase)
{
    ...
    _timer.Init((PFNTIMER)&CXnSock::TcpTimer);   /* RXDK: clang requires & for pointer-to-member */
}
