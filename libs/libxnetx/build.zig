...
// Include environment for the newer Xbox net stack (private/ntos/net). xnp.h (the
...
// rest are copied into inc/. Kernel-runtime component -- see site/bridge_xnetx.h.
...
pub fn addAllObjects(
    ...
    _ = xbox_target; // libxnetx pins its own MSVC target_triple (see note above)
