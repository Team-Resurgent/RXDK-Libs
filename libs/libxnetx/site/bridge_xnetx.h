#pragma once
#define RXDK_XNETX_BRIDGE_H

/*
 * Force-included before each libxnetx TU (which then #includes "xnp.h", the
 * stack's precompiled header). This is the NEWER Xbox net stack from
...
#endif
#define NTHALAPI
/* Some kernel prototypes reach libxnetx via the shared xboxkrnl/api headers,
