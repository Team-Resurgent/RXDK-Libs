...
// convention (first declaration wins). Mirrors libxnet/libd3d8/libdsound
// cdecl_libc.h. The set is exactly the libc symbols libxonline leaves undefined;
// extend if more appear. (__alldiv/__aullrem etc. are compiler 64-bit helpers with
// a fixed ABI -- not here.)
//------------------------------------------------------------------------------
