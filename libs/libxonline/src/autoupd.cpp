			...
			)
{
	...
	pautoupd->xontask.pfnContinue = &CXo::UpdateFromDVDContinue;
	pautoupd->xontask.pfnClose = &CXo::UpdateFromDVDClose;
	...
	pautoupd->dircopy.xontaskOnFile.pfnContinue = &CXo::UpdateDVDCountFilesContinue;
			...
			)
{
	...
	cbSize = MAX_PATH;
	hr = BuildTargetPath(dwTitleId, 0, 0,
				(CHAR*)((dirtype==dirtypeTitleUpdate)?
