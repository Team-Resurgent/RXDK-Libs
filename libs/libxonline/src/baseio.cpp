...
/*
 * File and socket I/O primitives shared by the online content-delivery and XRL
 * transfer code.
 */
            ...
            )
{
    ...
    pfileio->xontask.pfnContinue = &CXo::ReadWriteFileContinue;
    pfileio->xontask.pfnClose = &CXo::ReadWriteFileClose;
            ...
            )
{
    ...
    psockio->xontask.pfnContinue = &CXo::StreamConnectContinue;
    psockio->xontask.pfnClose = &CXo::StreamConnectClose;
            ...
            )
{
    ...
    TaskInitializeContext(&psockio->xontask);
    psockio->xontask.pfnContinue = &CXo::SendRecvContinue;
    psockio->xontask.pfnClose = &CXo::SendRecvClose;
    psockio->xontask.hEventWorkAvailable = hWorkEvent;
}
