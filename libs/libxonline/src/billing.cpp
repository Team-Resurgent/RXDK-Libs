                              ...
                              XONLINETASK_HANDLE *phTask )
{
    ...
    pXoPurch->Context.pfnContinue = &CXo::DoPurchaseContinue;
    pXoPurch->Context.pfnClose = &CXo::DoPurchaseClose;
                             ...
                             XONLINETASK_HANDLE *phTask )
{
    ...
    // the work function entry point.
    pXoCancel->Context.pfnContinue = &CXo::DoCancelContinue;
    pXoCancel->Context.pfnClose = &CXo::DoCancelClose;
                                 ...
                                 XONLINETASK_HANDLE      *phTask )
{
    ...
    pDetails->Context.pfnContinue           = &CXo::DoDetailsContinue;
    pDetails->Context.pfnClose              = &CXo::DoDetailsClose;
                                   ...
                                   XONLINETASK_HANDLE *phTask )
{
    ...
    pVerifyTask->Context.pfnContinue            = &CXo::VerifyLicenseTaskContinue;
    pVerifyTask->Context.pfnClose               = &CXo::VerifyLicenseTaskClose;
