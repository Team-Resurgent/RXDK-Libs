			...
			)
{
	...
	pinstall->xontask.pfnContinue = &CXo::contdlContinue;
	...
	pxrldlext->pfnDoneHeaders = &CXo::contdlDoneHeaders;
	pxrldlext->pfnProcessData = &CXo::contdlProcessData;
	pxrldlext->pfnCompleted = &CXo::contdlCompleted;
	pxrldlext->pfnInitializeTask = NULL;
	pxrldlext->pfnCleanup = &CXo::contdlCleanupHandler;
