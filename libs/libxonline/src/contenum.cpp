			...
			)
{
	...
	pxontaskEnum->pfnContinue = &CXo::contenumContinue;
	pxontaskEnum->pfnClose    = (PFNXONLINE_TASK_CLOSE)&CXo::contenumClose;
	...
	pxontaskPost->pfnContinue = &CXo::contenumPostUploadContinue;
			...
			)
{
	...
	plocalenum->xontask.pfnContinue = &CXo::ContentEnumerateLocalContinue;
	plocalenum->xontask.hEventWorkAvailable = hWorkEvent;

	// Initialize the OnDone task
	TaskInitializeContext(&plocalenum->xontaskDone);
	plocalenum->xontaskDone.pfnContinue = &CXo::ContentEnumerateLocalDone;
			...
			)
{
	...
	ptitleenum->xontask.pfnContinue = &CXo::EnumerateTitlesContinue;
