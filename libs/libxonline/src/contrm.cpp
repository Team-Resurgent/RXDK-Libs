...
/*
 * Content removal -- deletes installed content and reclaims its storage.
 */
			...
			)
{
	...
	pcontrm->xontask.pfnContinue = &CXo::contrmContinue;
	pcontrm->xontask.pfnClose = &CXo::contrmClose;
