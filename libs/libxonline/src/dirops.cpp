...
/*
 * Asynchronous directory operations used by the content and cache subsystems.
 */
			...
			)
{
	...
	pdirops->xontask.pfnContinue = &CXo::DiropsContinue;
	pdirops->xontask.pfnClose = &CXo::DiropsClose;
			...
			)
{
	...
	pdircrawl->xontask.pfnContinue = &CXo::DircrawlContinue;
	pdircrawl->xontask.pfnClose = &CXo::DircrawlClose;
			...
			)
{
	...
	pdircopy->xontaskOnDir.pfnContinue = &CXo::DirCopyDirContinue;
	pdircopy->xontaskOnDir.hEventWorkAvailable = hWorkEvent;
	
	TaskInitializeContext(&pdircopy->xontaskOnFile);
	pdircopy->xontaskOnFile.pfnContinue = &CXo::DirCopyFileContinue;
