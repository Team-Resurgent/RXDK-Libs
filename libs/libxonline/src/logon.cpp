...
HRESULT CXo::DNSLookup(char * pszDNSName, HANDLE hWorkEvent, XONLINETASK_DNS_LOOKUP * pDNSLookupTask)
{
    ...
    pDNSLookupTask->xonTask.pfnContinue = &CXo::DNSLookupContinue;
    pDNSLookupTask->xonTask.pfnClose = &CXo::DNSLookupClose;
...
HRESULT CXo::GetSingleTicket(BOOL fMachineAccount, PXKERB_TGT_CONTEXT pInputTGTContext, PXONLINE_USER pUser, HANDLE hWorkEvent, PXONLINETASK_HANDLE phGetSingleTicketTask)
{
    ...
    pGetSingleTicketTask->xonTask.pfnContinue = &CXo::GetSingleTicketContinue;
    pGetSingleTicketTask->xonTask.pfnClose = &CXo::GetSingleTicketClose;
...
HRESULT CXo::GetMachineAccount(HANDLE hWorkEvent, PXONLINETASK_HANDLE phGetMachineAccountTask)
{
    ...
    *phGetMachineAccountTask = NULL;
    ...
    pGetMachineAccountTask->xonTask.pfnContinue = &CXo::GetMachineAccountContinue;
    pGetMachineAccountTask->xonTask.pfnClose = &CXo::GetMachineAccountClose;
...
HRESULT CXo::GetCombinedTicket(PXONLINE_USER pMachineUser, BOOL fUseCache, HANDLE hWorkEvent, PXONLINETASK_HANDLE phGetCombinedTicketTask)
{
    ...
    *phGetCombinedTicketTask = NULL;
    ...
    pGetCombinedTicketTask->xonTask.pfnContinue = &CXo::GetCombinedTicketContinue;
    pGetCombinedTicketTask->xonTask.pfnClose = &CXo::GetCombinedTicketClose;
            ...
            )
{
    ...
    pGetServiceTicketTask->xonTask.pfnContinue = &CXo::GetServiceTicketContinue;
    pGetServiceTicketTask->xonTask.pfnClose = &CXo::GetServiceTicketClose;
    ...
    )
{
    ...
    pLogonTask->xonTask.pfnContinue = &CXo::LogonTaskContinue;
    pLogonTask->xonTask.pfnClose = &CXo::LogonTaskClose;
