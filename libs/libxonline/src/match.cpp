...
/*
 * Xbox matchmaking APIs -- session create, search and results over the
 * matchmaking service.
 */
    ...
    )
{
    ...
    (*ppExtendedHandle)->XMatchTaskHandle.pfnContinue = &CXo::MatchContinue;
    (*ppExtendedHandle)->XMatchTaskHandle.pfnClose = &CXo::MatchClose;
