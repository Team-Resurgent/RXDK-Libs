    ...
    )
{
    ...
    *phTask = NULL;
    ...
    pExtendedHandle->XPresenceTaskHandle.pfnContinue = &CXo::GameInviteContinue;
    pExtendedHandle->XPresenceTaskHandle.pfnClose = &CXo::GameInviteClose;
    ...
    )
{
    ...
    (*ppExtendedHandle)->XPresenceTaskHandle.pfnClose = &CXo::PresenceClose;
    ...
    switch (Type)
    {
        ...
        case PresenceAlive:
            (*ppExtendedHandle)->XPresenceTaskHandle.pfnContinue = &CXo::NotificationContinue;
            break;

        case FriendsGeneral:
        case LockoutlistGeneral:
            (*ppExtendedHandle)->XPresenceTaskHandle.pfnContinue = &CXo::FriendsContinue;
            break;
        ...
        case FriendsEnumerateNop:
            (*ppExtendedHandle)->XPresenceTaskHandle.pfnContinue = &CXo::FriendsEnumerateContinue;
            break;
    }
