...
/*
 * XRL upload APIs -- XOnlineUploadFromMemory and XOnlineUploadFile.
 */
			...
			)
{
	...
	pxrlasync->xontask.pfnContinue = &CXo::xrlulContinue;
			...
			)
{
	...
	pxrlasyncext->xontask.pfnContinue = &CXo::xrlufmContinue;
	pxrlasyncext->dwCurrentState = xrlufmDone;
	...
	pxrlulext->pfnCompleted = &CXo::xrlulsCompleted;
	pxrlulext->pfnResponseHeaders = &CXo::xrlulsResponseHeaders;
	pxrlulext->pfnInitializeTask = &CXo::xrlufmInitializeTask;
			...
			)
{
	...
	TaskInitializeContext(&pxrlasyncext->xontask);
	pxrlasyncext->xontask.pfnContinue = &CXo::xrlufContinue;
	pxrlasyncext->xontask.hEventWorkAvailable = hWorkEvent;
	pxrlasyncext->dwCurrentState = xrlufDone;
	...
	pxrlulext->pfnCompleted = &CXo::xrlulsCompleted;
	pxrlulext->pfnResponseHeaders = &CXo::xrlulsResponseHeaders;
	pxrlulext->pfnInitializeTask = &CXo::xrlufInitializeTask;
	pxrlulext->pfnCleanup = NULL;
	pxrlulext->hTaskPreConnect = NULL;
	pxrlulext->hTaskReadData = 
					(XONLINETASK_HANDLE)&(pxrlasyncext->xontask);;
