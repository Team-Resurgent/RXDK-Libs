...
/*
 * RXDK: the public Xbox Live client header (implemented by libxonline.lib).
 * Like the other public headers here (e.g. dsound.h) it is self-sufficient
 * title-side -- pull the title umbrella for XBOXAPI/WINAPI/HRESULT/DWORD and the
 * XNet public header for the XNKID/XNADDR matchmaking types the session/match
 * APIs below reference. No _WIN32/MinGW fallthrough: Xbox target only.
 */
#include <xtl.h>
#include <winsockx.h>
