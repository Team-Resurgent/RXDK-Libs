...
#ifdef DEBUG_MOUSE
XINPUT_MOUSE         MouseDefaults = {0, 0, 0, 0};
XID_REPORT_TYPE_INFO MouseReportInfoList[1] = {sizeof(XINPUT_MOUSE), (PVOID)&MouseDefaults};
XINPUT_POLLING_PARAMETERS MouseDefaultPolling = {TRUE, FALSE, 0, 8, 0, 0};
#endif
...
#ifdef DEBUG_MOUSE
    ,{XID_DEFAULT_MAX_MOUSE, XID_DEVSUBTYPE_MAX_MOUSE, XID_INPUT_REPORT_ID_MAX_MOUSE, XID_OUTPUT_REPORT_ID_MAX_MOUSE,
    MouseReportInfoList, NULL, &MouseDefaultPolling, XID_MouseNewData, 0}
#endif
    };